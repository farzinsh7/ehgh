...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function handleScroll() {
    if (window.scrollY > 100) {
      if (!topLogo.classList.contains('hidden-opacity')) {
        topLogo.classList.add('hidden-opacity');
        setTimeout(() => {
          topLogo.classList.add('hidden-display');
          topLogo2.classList.remove('hidden-display');
          requestAnimationFrame(() => {
            topLogo2.classList.remove('hidden-opacity');
          });
        }, 50);
      }
    } else {
      if (!topLogo2.classList.contains('hidden-opacity')) {
        topLogo2.classList.add('hidden-opacity');
        setTimeout(() => {
          topLogo2.classList.add('hidden-display');
          topLogo.classList.remove('hidden-display');
          requestAnimationFrame(() => {
            topLogo.classList.remove('hidden-opacity');
          });
        }, 50);
      }
    }
  ...
  function checkWindowSize() {
    if (window.innerWidth > 767) {
      ...
      if (window.scrollY > 100) {
        topLogo.classList.add('hidden-display', 'hidden-opacity');
        topLogo2.classList.remove('hidden-display', 'hidden-opacity');
      } else {
        topLogo.classList.remove('hidden-display', 'hidden-opacity');
        topLogo2.classList.add('hidden-display', 'hidden-opacity');
      }
    } else {
